...
pub enum WormholeCommands {
	...
	CollectRewards {
		...
		/// or --mnemonic) Use this with a secret generated by `quantus-node key quantus --scheme
		/// wormhole`
		...
		/// Destination address for withdrawn funds (required when using --mnemonic or
		/// --secret-file)
		#[arg(long)]
