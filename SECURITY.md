...
1. **GitHub private security advisory (preferred).**
   [Report a vulnerability](https://github.com/quantus-network/quantus-cli/security/advisories/new).
...
**In scope:** the Quantus CLI, including its quantum-safe wallet management and transaction signing — anything that could lead to exposure of keys or seeds, loss of funds, or a failed or incorrect transaction.
